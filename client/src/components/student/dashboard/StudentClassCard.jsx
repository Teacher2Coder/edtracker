          ...
          <Table.Body>
            ...
            assignments.map((assignment) => (
              <Table.Row key={assignment.id}>
                ...
                <Table.Cell textAlign="center">{assignment.assignDateFormatted}</Table.Cell>
                <Table.Cell textAlign="center">{assignment.dueDateFormatted}</Table.Cell>
                <Table.Cell textAlign="end">{assignment.status}</Table.Cell>
              </Table.Row>
            )) : 
            <Table.Row>
              <Table.Cell colSpan={4} textAlign="center">No assignments available</Table.Cell>
            </Table.Row>
            }
          </Table.Body>
        </Table.Root>
